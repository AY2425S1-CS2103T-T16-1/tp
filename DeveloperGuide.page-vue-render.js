...
with(this){return _c('p',[_c('strong',[_v("Use of Generative AI")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("AB3")])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"authentication-component"}},[_v("Authentication component"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#authentication-component","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Here's a partial class diagram of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Authentication")]),_v(" component:")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Authentication")]),_v(" component,")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("checks if user is authorised to access HR Helper.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The sequence diagram below illustrates the interactions within the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component, taking "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute(\"delete 2\")")]),_v(" API call as an example.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("working in the human resource department")]),_v(" "),_c('li',[_v("has a need to manage a significant number of employees")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": manage employee data faster than a typical mouse/GUI driven app")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR staff")]),_v(" "),_c('td',[_v("access help resources directly within the app")]),_v(" "),_c('td',[_v("troubleshoot issues without external assistance.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR staff")]),_v(" "),_c('td',[_v("sign into my account")]),_v(" "),_c('td',[_v("keep my data secure and verified.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR staff")]),_v(" "),_c('td',[_v("add new employee profiles")]),_v(" "),_c('td',[_v("keep the data current.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR staff")]),_v(" "),_c('td',[_v("delete an employee")]),_v(" "),_c('td',[_v("remove entries that I no longer need.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR staff")]),_v(" "),_c('td',[_v("find an employee by name")]),_v(" "),_c('td',[_v("locate details of employee quickly.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR staff")]),_v(" "),_c('td',[_v("find an employee by department")]),_v(" "),_c('td',[_v("find information regarding the department without having to go through all entries.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR staff")]),_v(" "),_c('td',[_v("export employee data in multiple formats")]),_v(" "),_c('td',[_v("easily share it with stakeholders.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR staff")]),_v(" "),_c('td',[_v("track employee annual leave")]),_v(" "),_c('td',[_v("manage staffing levels effectively.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR staff")]),_v(" "),_c('td',[_v("favorite employees")]),_v(" "),_c('td',[_v("track promotions and role changes")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("HR staff")]),_v(" "),_c('td',[_v("create custom tags for employee data")]),_v(" "),_c('td',[_v("capture information specific to my company's needs.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("HR staff")]),_v(" "),_c('td',[_v("search employee data with custom tags")]),_v(" "),_c('td',[_v("quickly find relevant groups of employees.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("HR Helper")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("HR staff")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Authentication")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("HR staff opens up HRHelper")])]),_v(" "),_c('li',[_c('p',[_v("HR Helper prompts for HR staff to enter Username and Password")])]),_v(" "),_c('li',[_c('p',[_v("HR staff keys in Username and Password")])]),_v(" "),_c('li',[_c('p',[_v("Authentication is successful, program continues")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. HR staff closes Authentication screen.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. HR Helper closes.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. Username/Password is empty.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. HR Helper prompts HR staff to enter username/password.")])]),_v(" "),_c('li',[_c('p',[_v("3b2. HR staff keys in Username and Password .")])]),_v(" "),_c('li',[_c('p',[_v("3b3. Correct Username and Password is entered.")]),_v(" "),_c('p',[_v("Use case resumes from step 4.")])])])]),_v(" "),_c('li',[_c('p',[_v("3c. Username and Password do not match.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3c1. HR Helper requests for Username or Password again.")])]),_v(" "),_c('li',[_c('p',[_v("3c2. Correct Username and Password is entered.")]),_v(" "),_c('p',[_v("Use case resumes from step 4.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add an employee")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Preconditions")]),_v(": HR staff is logged in.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("HR staff requests to add a specific employee in the list")])]),_v(" "),_c('li',[_c('p',[_v("HR Helper adds the employee.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. HR Helper detects an error in the name/phone number/email format provided by the HR staff.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. HR Helper requests for the correct data of the new employee.")])]),_v(" "),_c('li',[_c('p',[_v("1a2. HR staff enters new data.")])]),_v(" "),_c('li',[_c('p',[_v("Steps 1a1-1a2 are repeated until the data entered are correct.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The employee is already in the system.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. HR Helper informs the HR staff that the employee already exists in the HR Helper and does not add the duplicate employee.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: View and Edit Person Details")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Preconditions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("HR staff is logged in.")]),_v(" "),_c('li',[_v("HR staff has selected a specific employee from the employee list.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("HR staff selects an employee from the employee list in the MainWindow.")])]),_v(" "),_c('li',[_c('p',[_v("HR Helper opens the PersonDetailsWindow by pressing Enter (ENTER) key, displaying the selected employee's details in editable fields.")])]),_v(" "),_c('li',[_c('p',[_v("HR staff navigates between input fields using keyboard shortcuts:")])]),_v(" "),_c('li',[_c('p',[_v("HR staff edits the desired fields as needed.")])]),_v(" "),_c('li',[_c('p',[_v("HR staff presses the Enter (ENTER) key to save changes .")])]),_v(" "),_c('li',[_c('p',[_v("HR Helper validates the input")])]),_v(" "),_c('li',[_c('p',[_v("HR Helper updates the employee's details in the system.")])]),_v(" "),_c('li',[_c('p',[_v("HR Helper closes the PersonDetailsWindow, returning focus to the MainWindow.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("5a. HR staff presses the Escape (ESC) key to cancel editing.")]),_v(" "),_c('ul',[_c('li',[_v("5a1. HR Helper closes the PersonDetailsWindow without saving any changes.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("5b. HR staff enters invalid input (e.g., empty required fields or incorrect format).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("5b1. HR Helper detects invalid input during validation.")])]),_v(" "),_c('li',[_c('p',[_v("5b2. HR Helper displays an error message prompting HR staff to correct the input.")])]),_v(" "),_c('li',[_c('p',[_v("5b3. HR staff corrects the input.")]),_v(" "),_c('p',[_v("Use case resumes from step 4.")])])])]),_v(" "),_c('li',[_c('p',[_v("5c. HR staff attempts to save changes, but the employee record no longer exists (e.g., deleted by another user).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("5c1. HR Helper displays an error message indicating that the employee was not found.")])]),_v(" "),_c('li',[_c('p',[_v("5c2. HR Helper closes the PersonDetailsWindow.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Count employees")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Preconditions")]),_v(": HR staff is logged in.")])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("HR staff wants to count the number of employees in the list")])]),_v(" "),_c('li',[_c('p',[_v("HR Helper returns the number of employees that match the filtered tag or name.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. No employees match the tag or name requested")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("1b. The command format input does not follow the one prescribed.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. An error message showing the correct command format is displayed.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("HR staff requests to list employees")])]),_v(" "),_c('li',[_c('p',[_v("HR Helper shows a list of employees")])]),_v(" "),_c('li',[_c('p',[_v("HR staff requests to delete a specific employee in the list")])]),_v(" "),_c('li',[_c('p',[_v("HR Helper deletes the employee")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. HR Helper shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Mark a person as favorite")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Preconditions")]),_v(": HR staff is logged in.")])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("HR staff requests to mark a specific person in the list as a favorite.")])]),_v(" "),_c('li',[_c('p',[_v("HRHelper marks the person as a favorite.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The user does not have the authority to mark the person as favorite.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. The person is already marked as favorite.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. HRHelper notifies HR staff that the person is already a favorite.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Sort persons by tag")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Preconditions")]),_v(": HR staff is logged in.")])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("HR staff requests to sort persons by a specified tag (e.g., department or manager).")])]),_v(" "),_c('li',[_c('p',[_v("HRHelper sorts and displays the list based on the specified tag.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("1b. The given tag is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. HRHelper shows an error message.")])]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Search an employee")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Preconditions")]),_v(": HR staff is logged in.")])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("HR staff requests to list employees")])]),_v(" "),_c('li',[_c('p',[_v("HR Helper shows a list of employees")])]),_v(" "),_c('li',[_c('p',[_v("HR staff requests to search for a specific employee in the list (by name/contact/other information etc.)")])]),_v(" "),_c('li',[_c('p',[_v("HR Helper shows the employee/employees matching the description")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given description is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. HR Helper shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("4a. HR Helper gives HR staff the option to view the given employee.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Import CSV data")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Preconditions")]),_v(": HR staff is logged in.")])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("HR staff request to import data from CSV.")])]),_v(" "),_c('li',[_c('p',[_v("HR Helper adds all new data from CSV to existing data.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The command format input does not follow the one prescribed.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. An error message showing the correct command format is displayed.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Export CSV data")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Preconditions")]),_v(": HR staff is logged in.")])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("HR staff request to export data from HR Helper.")])]),_v(" "),_c('li',[_c('p',[_v("HR Helper exports data to CSV at requested file path.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ol',[_c('li',[_v("Download the jar file and copy into an empty folder.")]),_v(" "),_c('li',[_v("Double-click the jar file."),_c('br'),_v("\nExpected: Shows the HR Helper Login window.")])])]),_v(" "),_c('li',[_c('p',[_v("Authentication")]),_v(" "),_c('ol',[_c('li',[_v("Login using username and password."),_c('br'),_v("\nExpected: Shows the GUI with a set of sample employees. The window size may not be optimum.")])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")])]),_v(" "),_c('li',[_c('p',[_v("Re-launch the app by double-clicking the jar file."),_c('br'),_v("\nExpected: The most recent window size and location is retained.")])])])]),_v(" "),_c('li',[_c('p',[_v("Executing commands")]),_v(" "),_c('ol',[_c('li',[_v("Refer to the User Guide "),_c('a',{attrs:{"href":"https://ay2425s1-cs2103t-t16-1.github.io/tp/UserGuide.html#5-command-summary"}},[_v("here")]),_v(" for the list of commands.")])])]),_v(" "),_c('li',[_c('p',[_v("Closing the application")]),_v(" "),_c('ol',[_c('li',[_v("Use the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("exit")]),_v(" command to close the application.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("HR staff can change their username and password to keep their account secure.")]),_v(" "),_c('li',[_v("HR staff can track maternity leave of up to 6 months.")]),_v(" "),_c('li',[_v("Allow for the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("count")]),_v(" command to count number of favorited employees.")]),_v(" "),_c('li',[_v("Allow for the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v(" command to sort by multiple tags instead of just one tag.")]),_v(" "),_c('li',[_v("Allow for the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v(" command to sort not only by tag but also by other fields.")]),_v(" "),_c('li',[_v("Allow for the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("favorite")]),_v(" command to view only favorited employees.")]),_v(" "),_c('li',[_v("Implement Undo/Redo features for person details window to improve the user experience.")]),_v(" "),_c('li',[_v("Add a fix to make sure that certain duplicated information is not accepted by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command, such as phone number,\nemail etc.")]),_v(" "),_c('li',[_v("Fix invalid "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command message.")]),_v(" "),_c('li',[_v("Improve commands such that all of them are not case-sensitive.")])])}
},function anonymous(
) {
